let type = 'pro';
export const baseUrl = type == 'dev' ? `http://localhost:5000/node` : 'https://commit2care4pd.com/node'
const url = type == 'dev' ? `http://localhost:5000/node/api` : `https://commit2care4pd.com/node/api`
